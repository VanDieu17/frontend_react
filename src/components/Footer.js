          ...
          <div className='row'>
            <div className='col-4'>
              ...
              <div className='footer-link d-flex flex-column'>
                ...
                <a href="tel:+84 0909963300" className='mt-2 d-block mb-1 text-white'>+84 033608xxxx</a>
                <a href="mailto:69conheocon@gmail.com" className='mt-3 d-block mb-2 text-white'>nvdtore@gmail.com</a>
              </div>
            ...
            <div className='col-3'>
              ...
              <div className='footer-link d-flex flex-column'>
                <Link className='text-white py-2 mb-1' to= '/about'>Về NVD Store</Link>
                ...
                <Link className='text-white py-2 mb-1' to= '/blog'>Tin tức</Link>
              </div>
            </div>
            <div className='col-2'>
              <h4 className='text-white mb-4'>Dịch vụ</h4>
              <div className='footer-link d-flex flex-column'>
                <Link className='text-white py-2 mb-1' to= '/'>Giày đá bóng</Link>
                <Link className='text-white py-2 mb-1' to= '/'>Quần áo đá bóng</Link>
                <Link className='text-white py-2 mb-1' to= '/'>Quả bóng đá</Link>
                <Link className='text-white py-2 mb-1' to= '/'>Phụ kiện đá bóng</Link>
              </div>
            </div>
          </div>
        </div>
