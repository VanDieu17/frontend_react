                    ...
                    <div className="col-3">
                        ...
                        <div className='filter-card mb-3'>
                            ...
                            <div className='product-tags d-flex flex-wrap align-items-center gap-10'>
                                <span className="badge bg-light text-secondary rounded-3 py-2 px-2">Giày đá bóng</span>
                                <span className="badge bg-light text-secondary rounded-3 py-2 px-2">Quả bóng </span>
                                <span className="badge bg-light text-secondary rounded-3 py-2 px-2">Quần áo</span>
                                <span className="badge bg-light text-secondary rounded-3 py-2 px-2">Phụ kiện</span>
                            </div>
                        </div>
                        <div className='filter-card mb-3'>
                            ...
                            <div>
                                <div className="random-product d-flex mb-3">
                                    <div className="w-25">
                                        <img src='images/giaymizuno.jpg' className='img-fluid' alt='watch' />
                                    </div>
                                    <div className="w-75 ms-3">
                                        <h5>MORELIA SALA ELITE TF</h5>
                                        <ReactStars
                                            count={5}
                                            size={15}
                                            value= {3}
