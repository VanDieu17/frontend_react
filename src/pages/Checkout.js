                ...
                <div className="row">
                    <div className="col-7">
                     <div className="checkout-left-data">
                        <h3 className="website-name">NVD Store</h3>
                    ...
                    <div className="col-5">
                            ...
                            <div className="d-flex gap-10 mb-2 align-align-items-center">
                                <div className="w-75 d-flex gap-10">
                                    <div className="w-25 position-relative">
                                        ...
                                        <img className="img-fluid" src='/images/giaymizuno.jpg' alt="product" />
                                    </div>
                                    <div>
                                        <h5 className="total-price ">MORELIA SALA ELITE TF Size 39</h5>
                                        <p className="total-price">39 / Green</p>
                                    </div>
                                </div>
                                <div className="flex-grow-1">
                                <h5 className="total">3.590.000 VNĐ</h5>
                                </div>
                            </div>
                        </div>
                        <div className="border-bottom py-4">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <p className="total-price">3.590.000 VNĐ</p>
                            </div>
                            <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-flex justify-content-between align-items-center border-bootom py-4">
                            ...
                            <h5 className="total-price">3.640.000 VNĐ</h5>
                        </div>
                    </div>
                </div>
            </div>
