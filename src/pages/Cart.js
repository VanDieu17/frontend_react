                    ...
                    <div className='col-12'>
                        ...
                        <div className="cart-data py-3 mb-2 d-flex justify-content-between align-items-center">
                            <div className="cart-col-1 gap-15 d-flex align-items-center">
                                <div className="w-25">
                                <img src='images/giaymizuno.jpg' className="img-fluid" alt="product image" />
                                </div>
                                <div className="w-75">
                                    <strong>MORELIA SALA ELITE TF</strong><br/>
                                    <strong>3.590.000 VNĐ</strong><br/>
                                    <strong>Size: 39</strong><br/>
                                    <strong>Color: Green</strong><br/>
                                </div>
                            </div>
                            <div className="cart-col-2">
                                <h5 className="price">3.590.000 VNĐ</h5>
                            </div>
